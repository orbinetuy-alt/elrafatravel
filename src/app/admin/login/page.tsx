    ...
    <div className="min-h-screen bg-primary flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white uppercase tracking-widest">El Rafa Travel</h1>
          <p className="text-secondary text-sm mt-1 font-semibold uppercase tracking-widest">Panel de Administrador</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                type="email"
                required
                placeholder="admin@elrafatravel.com"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-secondary text-white font-bold py-3 rounded-lg uppercase tracking-wider hover:opacity-90 transition disabled:opacity-60"
            >
